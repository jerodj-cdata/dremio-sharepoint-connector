...
@SourceType(value = "SharePointARP", label = "SharePoint",uiConfig = "sharepoint-layout.json")
public class SharePointConf extends AbstractArpConf<SharePointConf> {
  private static final String ARP_FILENAME = "arp/implementation/sharepoint-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.sharepoint.SharePointDriver";
